<div>
        ...
        <div class="col-12">
            ...
            <div class="row mb-4">
                <div class="col-md-3 mb-3">
                    <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                        ...
                        <div>
                            <h6 class="mb-0">Mis Prestamistas</h6>
                ...
                <div class="col-md-3 mb-3">
                    <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-secondary mb-0">De mis productos</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mb-3">
            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>Mis Prestamistas</h6>
                </div>
                <div class="card-body px-0 pt-0 pb-2">
                    @if($borrowers->count() > 0)
                        <div class="table-responsive p-3">
                            <table id="myBorrowersTable" class="table table-hover align-items-center mb-0">
                                <thead>
                                    <tr>
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <p class="text-sm text-secondary mb-0">No tienes prestamistas registrados</p>
                            <p class="text-xs text-secondary">Los prestamistas aparecerán cuando alguien use tus productos financieros</p>
                        </div>
                    @endif
                </div>
            </div>
    ...
    @if($borrowers->count() > 0)
        ...
        <script>
            ...
            function initMyBorrowersTable() {
                if ($.fn.DataTable.isDataTable('#myBorrowersTable')) {
                    $('#myBorrowersTable').DataTable().destroy();
                }

                $('#myBorrowersTable').DataTable({
                    language: {
    ...
    <div class="modal fade show" style="display: block; background: rgba(0,0,0,0.7); z-index: 9999; position: fixed; top: 0; left: 0; width: 100%; height: 100%; overflow-y: auto;" tabindex="-1">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" style="z-index: 10000; max-width: 95%;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="card card-body border mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-sm mb-1"><strong>DNI:</strong> {{ $selectedBorrower->dni ?? 'N/A' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            <div class="card card-body border text-center">
                                <p class="text-xs text-secondary mb-1">Progreso de Pago</p>
                    ...
                    <div class="card mb-3">
                        <div class="card-header pb-0">
                            <h6><i class="fas fa-shopping-cart me-2"></i>Compras Realizadas</h6>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2">
                                    ...
                                    <table class="table table-sm align-items-center mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Producto Usado</th>
                                        ...
                                        <tbody>
                                            @foreach($borrowerTransactions as $transaction)
                                                <tr>
                                                    ...
                                                    <td class="align-middle text-center"><span class="badge badge-sm bg-gradient-info">{{ $transaction->installment_count ?? '-' }}</span></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                    ...
                    <div class="card mb-3">
                        <div class="card-header pb-0">
                            <h6><i class="fas fa-calendar-alt me-2"></i>Planes de Cuotas</h6>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <div class="card mb-3">
                        <div class="card-header pb-0">
                            <h6><i class="fas fa-money-bill-wave me-2"></i>Historial de Pagos Realizados</h6>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2">
                            @if(count($borrowerPayments) > 0)
                                <div class="table-responsive p-3">
                                    <table class="table table-sm align-items-center mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Producto</th>
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Monto Pagado</th>
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Saldo Después</th>
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Registrado</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($borrowerPayments as $payment)
                                                <tr>
                                                    <td><p class="text-xs mb-0 ps-3 font-weight-bold">{{ \Carbon\Carbon::parse($payment['payment_date'])->format('d/m/Y') }}</p></td>
                                                    <td><p class="text-xs mb-0">{{ $payment['installment']->financialProduct?->name ?? 'N/A' }}</p></td>
                                                    <td class="align-middle text-center"><span class="text-xs font-weight-bold text-success">S/ {{ number_format($payment['amount_dollars'], 2) }}</span></td>
                                                    <td class="align-middle text-center"><span class="text-xs text-warning">S/ {{ number_format($payment['remaining_after'], 2) }}</span></td>
                                                    <td><p class="text-xxs text-secondary mb-0">{{ $payment['registered_at'] ? \Carbon\Carbon::parse($payment['registered_at'])->format('d/m/Y H:i') : 'N/A' }}</p></td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                            ...
                            @else
                                <div class="text-center py-3">
                                    <p class="text-sm text-secondary mb-0">No hay pagos registrados aún</p>
                                </div>
                            @endif
                        </div>
                    </div>
